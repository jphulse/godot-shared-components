...
var sockets: Array[SnapSocket3D] = []
...
func get_sockets() -> Array[SnapSocket3D]:
	var copied_sockets: Array[SnapSocket3D] = []

	for socket: SnapSocket3D in sockets:
...
func get_open_sockets() -> Array[SnapSocket3D]:
	var open_sockets: Array[SnapSocket3D] = []
...
func get_auto_connect_open_sockets() -> Array[SnapSocket3D]:
	var open_sockets: Array[SnapSocket3D] = []
...
func get_socket_by_id(target_socket_id: StringName) -> SnapSocket3D:
	for socket: SnapSocket3D in sockets:
...
func get_compatible_open_sockets(target_socket: SnapSocket3D) -> Array[SnapSocket3D]:
	var compatible_sockets: Array[SnapSocket3D] = []

	for socket: SnapSocket3D in get_open_sockets():
...
func get_auto_compatible_open_sockets(target_socket: SnapSocket3D) -> Array[SnapSocket3D]:
	var compatible_sockets: Array[SnapSocket3D] = []

	for socket: SnapSocket3D in get_auto_connect_open_sockets():
...
## Recursively collects SnapSocket3D children from the given root node.
func _collect_sockets_recursive(root_node: Node, output_sockets: Array[SnapSocket3D]) -> void:
	for child_node: Node in root_node.get_children():
		var socket: SnapSocket3D = child_node as SnapSocket3D
